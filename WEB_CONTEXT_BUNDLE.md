...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.48"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-v1",
      "problem_contract_sha256": "b37a6ccf104bdc898aa2320957446beaaeb0b773e52810a164355daf60019f08",
      "problem_id": "problem:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e",
      "route_id": "route:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-source-fidelity-01",
      "graph_id": "graph:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A quasimorphism on a group $G$ is a function $f:G\\to\\mathbb R$ such that the quantity $\\sup_{g,h}|f(g)+f(h)-f(gh)|$ is finite. A quasimorphism is homogeneous if it restricts to a homomorphism on every cyclic subgroup of $G$. Let $G$ be a group admitting an unbounded homogeneous quasimorphism $G\\to\\mathbb R$ that is not a homomorphism. Must $G$ contain a non-abelian free subgroup?"
          },
          "statement_sha256": "35d2050a0ce029dc8b284dd21871d8bcdc83836f5da73109d42d762a7ae5f21f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-root",
      "route_id": "route:um-kou-21.48-kourovka-notebook-problem-21.48-0394123e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.48-28109c09c0db",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.48"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
